...
// Command-line arguments: run ex1.dfy 0
// ex1.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _0_realArgs;
      _0_realArgs = args;
      if (((new BigInteger((_0_realArgs).Count)).Sign == 1) && (((_0_realArgs).Select(BigInteger.Zero)).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("dotnet")))) {
        _0_realArgs = (_0_realArgs).Drop(BigInteger.One);
      }
      if ((new BigInteger((_0_realArgs).Count)) < (BigInteger.One)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Usage: abs <x>\n")).ToVerbatimString(false));
        return ;
      }
      BigInteger _1_x;
      BigInteger _out0;
      _out0 = __default.ParseInt((_0_realArgs).Select(BigInteger.Zero));
      _1_x = _out0;
      BigInteger _2_r;
      BigInteger _out1;
      _out1 = __default.Abs(_1_x);
      _2_r = _out1;

...
// Command-line arguments: run ex2.dfy 9 2 7
// ex2.dfy

method Max3(a: int, b: int, c: int)
    returns (m: int)
  ensures m >= a && m >= b && m >= c
  decreases a, b, c
{
  ...
  public partial class __default {
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> args)
    {
      ...
      if ((new BigInteger((_0_rArgs).Count)) < (new BigInteger(3))) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Usage: max3 <a> <b> <c>\n")).ToVerbatimString(false));
        return ;
      }
      BigInteger _1_a;
      BigInteger _out0;
      ...
      BigInteger _4_m;
      BigInteger _out3;
      _out3 = __default.Max3(_1_a, _2_b, _3_c);
      _4_m = _out3;
      Dafny.Helpers.Print((_4_m));

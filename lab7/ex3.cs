...
// Command-line arguments: run ex3.dfy 3 5 9
// ex3.dfy

method Clamp(x: int, lo: int, hi: int)
    returns (r: int)
  requires lo <= hi
  decreases x, lo, hi
{
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger Clamp(BigInteger x, BigInteger lo, BigInteger hi)
    {
    ...
    {
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _0_rArgs;
      _0_rArgs = args;
      if (((new BigInteger((_0_rArgs).Count)).Sign == 1) && (((_0_rArgs).Select(BigInteger.Zero)).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("dotnet")))) {
        _0_rArgs = (_0_rArgs).Drop(BigInteger.One);
      }
      if ((new BigInteger((_0_rArgs).Count)) < (new BigInteger(3))) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Usage: clamp <x> <lo> <hi>\n")).ToVerbatimString(false));
        return ;
      }
      BigInteger _1_x;
      BigInteger _out0;
      _out0 = __default.ParseInt((_0_rArgs).Select(BigInteger.Zero));
      _1_x = _out0;
      BigInteger _2_lo;
      BigInteger _out1;
      _out1 = __default.ParseInt((_0_rArgs).Select(BigInteger.One));
      _2_lo = _out1;
      BigInteger _3_hi;
      BigInteger _out2;
      _out2 = __default.ParseInt((_0_rArgs).Select(new BigInteger(2)));
      _3_hi = _out2;
      if ((_2_lo) > (_3_hi)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: lo must be less than or equal to hi\n")).ToVerbatimString(false));
        return ;
      }
      BigInteger _4_r;
      BigInteger _out3;
      _out3 = __default.Clamp(_1_x, _2_lo, _3_hi);
      _4_r = _out3;
      Dafny.Helpers.Print((_4_r));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
    public static BigInteger ParseInt(Dafny.ISequence<Dafny.Rune> s)
    {
      BigInteger n = BigInteger.Zero;
      BigInteger _0_i;
      _0_i = BigInteger.Zero;
      BigInteger _1_sign;
      _1_sign = BigInteger.One;
      n = BigInteger.Zero;
      if ((new BigInteger((s).Count)).Sign == 0) {
        return n;
      }
      if (((s).Select(BigInteger.Zero)) == (new Dafny.Rune('-'))) {
        _1_sign = new BigInteger(-1);
        _0_i = BigInteger.One;
      ...
      while ((_0_i) < (new BigInteger((s).Count))) {
        BigInteger _2_c;
        _2_c = new BigInteger(((s).Select(_0_i)).Value);
        BigInteger _3_d;
        _3_d = (_2_c) - (new BigInteger((new Dafny.Rune('0')).Value));
        if (((_3_d).Sign == -1) || ((_3_d) > (new BigInteger(9)))) {
          n = BigInteger.Zero;
          return n;
        }
        n = ((n) * (new BigInteger(10))) + (_3_d);

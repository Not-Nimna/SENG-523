// Dafny program ex4.dfy compiled into C#
...
// Command-line arguments: run ex4.dfy 3
// ex4.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> args)
    {
      ...
      if ((new BigInteger((_0_rArgs).Count)) < (BigInteger.One)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Usage: sumupto <n>\n")).ToVerbatimString(false));
        return ;
      }
      BigInteger _1_nInt;
      BigInteger _out0;
      ...
      _1_nInt = _out0;
      if ((_1_nInt).Sign == -1) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error: n must be nonnegative.\n")).ToVerbatimString(false));
        return ;
      }
      BigInteger _2_n;
      _2_n = _1_nInt;
      BigInteger _3_s;
      _3_s = __default.SumUpTo(_2_n);
